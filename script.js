...
const FAKE_LEADS = [
  ...
  },
  {
    ...
    last_interaction: '2026-06-01T14:22:00',
  ...
  },
  {
    ...
    stage: 'Interessado',
    status: 'Quente',
    responsible: 'Fernanda Reis',
    notes: 'Muito interessada! Quer começar na próxima turma. Verificar disponibilidade.',
    last_message: 'Adorei a proposta! Tenho interesse na bolsa de 20%. Como faço para reservar minha vaga?',
    last_interaction: '2026-06-02T08:00:00',
  ...
  },
  {
    ...
    name: 'Bruno Tavares',
    phone: '41991234004',
    course_interest: 'Técnico em Eletrotécnica',
    source: 'Indicação',
    stage: 'Em Atendimento',
    status: 'Em atendimento',
    responsible: 'João Silva',
    notes: 'Indicado pelo Pedro (aluno atual). Muito motivado. Reunião marcada para amanhã.',
    last_message: 'Sim, posso comparecer na reunião amanhã às 10h.',
    last_interaction: '2026-06-01T16:30:00',
  ...
  },
  {
    ...
    name: 'Carla Mendes',
    phone: '41991234005',
    course_interest: 'Técnico em Meio Ambiente',
    source: 'Facebook',
    stage: 'Em Atendimento',
    status: 'Sem resposta',
    responsible: 'Ana Lima',
    notes: 'Ficou de enviar documentos mas não retornou. Ligar amanhã.',
    last_message: 'Vou verificar os documentos aqui e te mando.',
    last_interaction: '2026-05-28T11:00:00',
  ...
  },
  {
    ...
    source: 'WhatsApp',
    stage: 'Documentação/Matrícula',
    status: 'Em atendimento',
    responsible: 'Carlos Souza',
    notes: 'Enviou RG e CPF. Falta comprovante de residência.',
    last_message: 'Enviei os documentos! Falta só o comprovante de residência, vou conseguir essa semana.',
    last_interaction: '2026-06-01T10:00:00',
    created_at: '2026-05-15T09:00:00',
    tags: ['Documentação', 'WhatsApp'],
    messages: [
      { text: 'Olá, tenho interesse no Técnico em Informática via WhatsApp.', direction: 'in', received_at: '2026-05-15T09:00:00' },
      { text: 'Enviei os documentos! Falta só o comprovante de residência, vou conseguir essa semana.', direction: 'in', received_at: '2026-06-01T10:00:00' }
    ],
    movements: [
      ...
      { from_stage: 'Primeiro Contato', to_stage: 'Interessado', moved_at: '2026-05-18T09:00:00' },
      { from_stage: 'Interessado', to_stage: 'Em Atendimento', moved_at: '2026-05-20T09:00:00' },
  ...
  },
  {
    ...
    last_interaction: '2026-06-01T15:00:00',
    ...
    movements: [
      ...
      { from_stage: 'Leads de Entrada', to_stage: 'Primeiro Contato', moved_at: '2026-05-10T10:00:00' },
      { from_stage: 'Primeiro Contato', to_stage: 'Interessado', moved_at: '2026-05-11T09:00:00' },
      { from_stage: 'Interessado', to_stage: 'Em Atendimento', moved_at: '2026-05-13T09:00:00' },
      { from_stage: 'Em Atendimento', to_stage: 'Documentação/Matrícula', moved_at: '2026-05-20T09:00:00' },
      { from_stage: 'Documentação/Matrícula', to_stage: 'Aguardando Pagamento', moved_at: '2026-05-30T09:00:00' }
    ]
  },
  {
    id: 'lead_008',
    name: 'Lucas Oliveira',
    phone: '41991234008',
    course_interest: 'Técnico em Contabilidade',
    source: 'Site',
    stage: 'Aguardando Pagamento',
    status: 'Quente',
    responsible: 'João Silva',
    ...
    last_interaction: '2026-06-02T07:30:00',
    ...
    movements: [
      ...
      { from_stage: 'Leads de Entrada', to_stage: 'Primeiro Contato', moved_at: '2026-05-08T10:00:00' },
      { from_stage: 'Primeiro Contato', to_stage: 'Interessado', moved_at: '2026-05-09T09:00:00' },
      { from_stage: 'Interessado', to_stage: 'Em Atendimento', moved_at: '2026-05-12T09:00:00' },
      { from_stage: 'Em Atendimento', to_stage: 'Documentação/Matrícula', moved_at: '2026-05-18T09:00:00' },
      { from_stage: 'Documentação/Matrícula', to_stage: 'Aguardando Pagamento', moved_at: '2026-05-28T09:00:00' }
    ]
  },
  {
    id: 'lead_009',
    ...
    last_interaction: '2026-05-31T16:00:00',
    ...
    movements: [
      ...
      { from_stage: 'Leads de Entrada', to_stage: 'Primeiro Contato', moved_at: '2026-05-01T10:00:00' },
      { from_stage: 'Primeiro Contato', to_stage: 'Interessado', moved_at: '2026-05-03T09:00:00' },
      { from_stage: 'Interessado', to_stage: 'Em Atendimento', moved_at: '2026-05-05T09:00:00' },
      { from_stage: 'Em Atendimento', to_stage: 'Documentação/Matrícula', moved_at: '2026-05-10T09:00:00' },
      { from_stage: 'Documentação/Matrícula', to_stage: 'Aguardando Pagamento', moved_at: '2026-05-20T09:00:00' },
  ...
  },
  {
    ...
    last_interaction: '2026-05-29T11:00:00',
    ...
    movements: [
      ...
      { from_stage: 'Leads de Entrada', to_stage: 'Primeiro Contato', moved_at: '2026-04-25T10:00:00' },
      { from_stage: 'Primeiro Contato', to_stage: 'Interessado', moved_at: '2026-04-27T09:00:00' },
      { from_stage: 'Interessado', to_stage: 'Em Atendimento', moved_at: '2026-04-29T09:00:00' },
      { from_stage: 'Em Atendimento', to_stage: 'Documentação/Matrícula', moved_at: '2026-05-05T09:00:00' },
      { from_stage: 'Documentação/Matrícula', to_stage: 'Aguardando Pagamento', moved_at: '2026-05-15T09:00:00' },
